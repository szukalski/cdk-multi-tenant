...
import { MultiTenantLogGroup } from '../log-group/log-group';

export interface SmithyServerProps {
...
export class SmithyServer extends Construct {
  api: SpecRestApi;
  serviceFunction: IFunction;
  serviceAuthorizer?: IFunction;
  constructor(scope: Construct, id: string, props: SmithyServerProps) {
    super(scope, id);
    ...
    const logGroup = props.logGroup ?? new MultiTenantLogGroup(this, 'LogGroup');
